...
<nav class="navbar" style="background-color: #e3f2fd">
    <div class="container-fluid" >
        ...
        <form action="${pageContext.request.contextPath}/user-contacts/search-contacts?serach=${pageContext.request.getParameter("search")}" method="get" class="d-flex" role="search" >
            <input class="form-control me-2" name="search" type="search" placeholder="Search Contact" aria-label="Search" style="margin:5px">
...
<div style="display: flex ; justify-self: center; justify-content: space-between; margin-top: 20px;">
    <h4 style="margin-left: 15px;">Contacts by search ' ${pageContext.request.getParameter("search")} '</h4>

    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-right: 15px;">
        Add Contact
    </button>
</div>
...
<table class="table table-striped-columns"
    ...
    <c:forEach var="contact" items="${contactSearchList}">
        <tr style="text-align: center">
                ...
                <td style="display: flex; justify-content: space-evenly;">
                    ...
                    <a href="${pageContext.request.contextPath}/user-contacts/block-contact?id=${contact.contactId}">
                        <button type="button" class="btn btn-light">Block</button></a>
                </td>
